...
# Создайте коммит
git commit -m "Initial commit: Crypto LSTM Predictor Mini App"

# Создайте репозиторий на GitHub
# Перейдите на https://github.com/new
# Название: PulseTrade-Bot
# Public или Private - на ваш выбор
# НЕ создавайте README, .gitignore, license

# Добавьте remote (замените YOUR_USERNAME на ваш username)
git remote add origin https://github.com/YOUR_USERNAME/PulseTrade-Bot.git
...
### 8.2 Создание Web Service

1. На главной странице Render нажмите **"New +"**
2. Выберите **"Web Service"**

### 8.3 Подключение репозитория

1. Найдите **PulseTrade-Bot** в списке
2. Нажмите **"Connect"**

Если репозиторий не появился:
- Нажмите **"+ Connect account"**
- Выберите GitHub
- Дайте доступ к репозиторию

### 8.4 Настройки проекта

Заполните поля:

**Name:** `pulsetrade-bot` (или любое другое)
...
**Instance Type:** `Free` (выберите Free план)

### 8.5 Environment Variables (необязательно)

Пока не нужны переменные окружения для API.
...
2. ✅ Установка зависимостей (это займет 3-5 минут)
3. ✅ Запуск приложения

Вы увидите логи в реальном времени.

### 9.2 Ожидайте сообщение
```
...
```
https://pulsetrade-bot.onrender.com
```
...
### 10.1 Откройте URL в браузере
```
https://pulsetrade-bot.onrender.com
```

Должна открыться страница Mini App с выбором криптовалют! 🎉

### 10.2 Проверьте API
```
https://pulsetrade-bot.onrender.com/api/health